...
def lowercase():
    with open("happy.txt") as F:
        ...
        print(f"The total number of lower case letters are{word_counter.get_total_upper()}")

        print(f"The total number of lower case letters are{word_counter.get_total()}")
